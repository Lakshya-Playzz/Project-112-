...
classifier = ml5.imageClassifier("https://teachablemachine.withgoogle.com/models/1i7iqWhv0/model.json" , modelLoaded)
...
console.log(error);
    ...
    document.getElementById("hand_gestures_name_1").innerHTML = Prediction1
